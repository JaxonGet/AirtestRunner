...
def CreateContract():
    ...
    try:
        ...
        pass
    Contract_ui = poco(text="合同号")

    # Contract_no = poco("com.huifenqi.broker:id/tv_con_num").get_text
    # print(("合同号为：%s")%Contract_no)
    poco.wait_for_any([Contract_ui])
    End_txt = poco("com.huifenqi.broker:id/tv_qrcode_info")
    Title = End_txt.get_text()
    return Title
